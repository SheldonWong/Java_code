...
public static void main(String[] args){
	...
	for (Element link : links) {
		...
		//write excel
		Label label_date = new Label(0, i,el_date.text());
		Label label_title = new Label(1, i,el_title.text());
		Label label_grade = new Label(2, i,el_grade.val());
		Label label_subject = new Label(3, i,el_subject.val());
		Label label_content = new Label(4, i,el_content.text());
